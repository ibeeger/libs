...
* @Last Modified time: 2018-05-03 10:30:26
*/
...
client.post("/ws",{
	...
	"imgsearch_result": "",
	"service_name": "",
	"request_query": "用"+process.argv[2]+"组词",
	"query_type": "1",
	"debug": "0",
	"longitude": 116.34625262778013,
	"latitude": 39.9573942425007
},function(data){
	data = JSON.parse(data);
	console.log(data.result_list[0].result_content);
})