...
setupWebViewJavascriptBridge(function(bridge) {
	...
	function indexfun() {
		...
		bridge.callHandler('isLogin', '', function(response) {
			if (response != null && response != undefined) {
				...
				/* 加签 */
				timestamp = new Date("2017-12-20 19:46:32").Format("yyyy-MM-dd hh:mm:ss");
	...
	$(function() {
		...
		$("#btnsign").click(function(){
				...
				var str = ""
				for(var k in bridgewai){
					str+=k+"<br />";
				};
				// document.getElementById('thd').innerHTML = str;
				try{
					var jjzobj = {}
					Object.defineProperty(jjzobj,"tm",{
					set:function(v){
						var timestamp = Date.parse(new Date(v*1000));
						var parajson = {
							userid: userid,
							appkey: appkey,
							deviceid: deviceid,
